...
export interface CampaignObjective {
    type: 'BRAND_AWARENESS' | 'REACH' | 'TRAFFIC' | 'ENGAGEMENT' | 'APP_INSTALLS' | 'VIDEO_VIEWS' | 'LEAD_GENERATION' | 'MESSAGES' | 'CONVERSIONS' | 'SALES';
}
...
export interface CampaignPerformance extends PerformanceMetrics {
    ...
    breakdown?: {
        byAge?: {
            [ageGroup: string]: PerformanceMetrics;
        };
        byGender?: {
            [gender: string]: PerformanceMetrics;
        };
        byLocation?: {
            [location: string]: PerformanceMetrics;
        };
        byDevice?: {
            [device: string]: PerformanceMetrics;
        };
        byCreative?: {
            [creativeId: string]: PerformanceMetrics;
        };
    };
}
